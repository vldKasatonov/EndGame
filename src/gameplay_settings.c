...
static void draw_exit_confirmation(bool *is_exit_popup_open, int *counter, bool *cursor_changed) {
    ...
    Rectangle popup_rect = {(GetScreenWidth() - popup_width) / 2,
...
void mx_render_gameplay_settings(t_game_textures *textures, float *volume_music,
                                 float *volume_effects, bool *is_exit_popup_open, int *counter) {
    ...
    Rectangle slider_bar_music = {center_x - slider_width / 2, center_y - 50,
                                  slider_width, slider_height };
    Rectangle slider_bar_effects = {center_x - slider_width / 2, center_y  + 90,
                                    slider_width, slider_height};
    ...
    int icon_size = 50;
    Rectangle icon_music_rect = {slider_bar_music.x - icon_size - 30,
    ...
    DrawCircleV((Vector2){slider_knob_music.x + circle_size / 2,
                          slider_knob_music.y + circle_size / 2},
    ...
    DrawCircleV((Vector2){slider_knob_effects.x + circle_size / 2,
                          slider_knob_effects.y + circle_size / 2},
                circle_size * 0.65, custom_colors.slider_color);
    ...
    DrawTexturePro(textures->guide,
                   (Rectangle){0, 0, textures->guide.width, textures->guide.height},
    ...
    Rectangle resume_button = {button_x2, button_y12,
                               button_width3, button_height3};
    Rectangle quit_button = {button_x2 + button_width3 + button_spacing,
                             button_y12, button_width3, button_height3};
    float corner_radius1 = 0.5f;
    DrawRectangleRounded(resume_button, corner_radius1,
                         segments, custom_colors.music_color);
    DrawRectangleRounded(quit_button, corner_radius1,
                         segments, custom_colors.music_color);
    int font_size1 = 40;
